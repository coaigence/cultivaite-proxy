// ============================================================
//  cultivaite proxy server v4
//  coaigence | a hybrid intelligence company
//  Web search enabled for real Market Map data
// ============================================================
...
const MODEL = 'claude-sonnet-4-20250514'; // Sonnet for web search capability
...
// ── Health check ──
app.get('/', (req, res) => {
  res.json({ status: 'cultivaite proxy running v4' });
});
